...
public class FinishActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//this.roboto.setBatteryLevel(666);
		batteryStatement.setText(String.valueOf( this.roboto.getBatteryLevel())); 
		pathLengthStatement.setText(String.valueOf( this.roboto.counter)); 
		
		if(this.maze.isEndPosition(this.maze.px, this.maze.py)||this.roboto.isAtGoal()){
